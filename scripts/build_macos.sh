...
# 固定：macOS 14 arm64、Python 3.14.6、Node.js 24.19.0、pnpm 11.5.0。
...
command -v node >/dev/null || fail "未找到 Node.js 24.19.0"
[[ "$(node --version | sed 's/^v//')" == "24.19.0" ]] || fail "需要 Node.js 24.19.0"
